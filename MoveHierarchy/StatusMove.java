...
public class StatusMove extends Move {
	...
	/**
   	...
   	* the health modifier of the Status Move
	...
	/**
   	* This method is an accessor that allows other classes to access
   	* the attack modifier of the Status Move
	...
	/**
   	* This method is an accessor that allows other classes to access
   	* the defence modifier of the Status Move
	...
	/**
   	* This method is an accessor that allows other classes to access
   	* the speed modifier of the Status Move
	...
	* the Status Move class when given its 
